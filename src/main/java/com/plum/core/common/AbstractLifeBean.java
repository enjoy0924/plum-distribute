 ...
 * @author davidc
 */
public abstract class AbstractLifeBean implements ApplicationListener, ApplicationContextAware
{
    protected final static Log log = LogFactory.getLog(AbstractLifeBean.class);    
