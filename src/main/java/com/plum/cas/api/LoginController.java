...
import com.plum.cas.component.AuthenticationService;
...
//        System.out.println("http sessionId: " + request.getSession().getId());
        ...
        authenticationService.authenticate(username, password, principalAndCredential.isRememberMe());
...
//        if(currentUser.isAuthenticated()){
//
//            currentUser.getSession().setAttribute(CONST.CURRENT_USER, username + "@" + appKey);
//
