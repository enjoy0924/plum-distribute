package com.plum.cas.web.taglib;


import com.plum.cas.dto.*;
import com.plum.cas.service.*;
import com.plum.cas.utils.SpringUtils;
...
public class Functions {
    ...
    public static String username(Long userId) {
        User user = getUserService().findByIndex(userId);
        if(user == null) {
            return "";
        }
    ...
    public static String appName(Long appId) {
        App app = getAppService().findByIndex(appId);
        if(app == null) {
            return "";
        }
        return app.getName();
    ...
    public static String organizationName(Long organizationId) {
        Organization organization = getOrganizationService().findByIndex(organizationId);
    ...
    public static String roleName(Long roleId) {
        Role role = getRoleService().findByIndex(roleId);
        if(role == null) {
            return "";
        }
    ...
    public static String resourceName(Long resourceId) {
        Resource resource = getResourceService().findByIndex(resourceId);
        if(resource == null) {
            return "";
        }
